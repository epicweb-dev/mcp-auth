...
👨‍💼 When clients provide an authentication token that turns out to be invalid, they need clear feedback about what went wrong. Without proper error messaging, users might think the service is broken or get confused about why their request failed.
...
sequenceDiagram
    ...
    MCP Client->>User: Shows "Please sign in again"
```
...
<callout-warning>
	...
	allows more detail. Avoid leaking whether a token is expired, revoked,
